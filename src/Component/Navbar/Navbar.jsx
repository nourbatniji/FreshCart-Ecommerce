    ...
    <>
      <nav className='shadow-xl py-2 fixed w-full top-0 left-0 z-50 bg-white'>
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between md:justify-center mx-auto p-4">
          ...
          <div className="hidden w-10/12  md:flex md:justify-between" id="navbar-default">
            {token ?
              <ul className="font-medium flex flex-col items-center p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white">
                ...
                <li className='flex items-center'>
                  <NavLink to="/cart" className={(x) => x.isActive ? "block py-2 text-active px-3 md:p-0" : "block py-2 px-3 md:p-0"} >Cart</NavLink>
                </li>
              </ul> : ""}
          ...
          <li className='flex items-center'>
                <a href='https://www.facebook.com/' className="block py-2 md:p-0 hover:text-active duration-500" target='_blank'><i className='fa-brands fa-facebook'></i></a>
              </li>
          <li className='flex items-center'>
                <a href='https://www.instagram.com/' className="block py-2 md:p-0 hover:text-active duration-500 " target='_blank' ><i className='fa-brands fa-instagram'></i></a>
              </li>
          <li className='flex items-center'>
                <a href='https://www.linkedin.com/' className="block py-2 md:p-0 hover:text-active duration-500 " target='_blank'><i className='fa-brands fa-linkedin'></i></a>
              </li>
          <li className='flex items-center'>
                <a href='https://www.x.com/' className="block py-2 md:p-0 hover:text-active duration-500 " target='_blank'><i className='fa-brands fa-twitter'></i></a>
              </li>
