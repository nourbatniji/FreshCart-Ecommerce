  ...
  return (
    <div className="mt-28 mb-20 px-4 md:px-0">
      {cartData && cartData.products.length > 0 ? (
          ...
          <div className="p-6 md:p-10">
            ...
            <div className="divide-y divide-gray-100">
              {cartData.products.map((element) => {
                ...
                return (
                  <div key={product._id || product.id} className="py-6 flex flex-col md:flex-row items-center justify-between gap-6 hover:bg-gray-50/50 transition duration-300 rounded-xl px-2">
                    <div className="flex items-center gap-6 w-full md:w-8/12">
                      ...
                      <div className="flex-1">
                        ...
                        <button 
                          onClick={() => deleteItem(product._id || product.id)}
                    ...
                    <div className="flex items-center gap-3 bg-gray-50 border border-gray-100 rounded-lg p-1">
                      <button 
                        onClick={() => updateCount(product._id || product.id, element.count - 1)}
                      ...
                      <span className="w-8 text-center font-bold text-gray-800">{element.count}</span>
                      <button 
                        onClick={() => updateCount(product._id || product.id, element.count + 1)}
                        className="w-8 h-8 rounded-md bg-white border border-gray-200 flex items-center justify-center hover:bg-gray-100 active:scale-95 transition cursor-pointer"
                      >
        ...
        <div className="max-w-md mx-auto text-center py-20 bg-white rounded-2xl shadow-xl border border-gray-150 px-6">
